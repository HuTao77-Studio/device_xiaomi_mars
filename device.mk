...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/audio/sku_lahaina/,$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_lahaina)
...
PRODUCT_PACKAGES += \
    ...
    android.hardware.biometrics.fingerprint@2.3-service.xiaomi_mars \
...
PRODUCT_PACKAGES += \
    ...
    vendor.lineage.livedisplay@2.1-service.xiaomi_mars
endif
...
# PowerShare
PRODUCT_PACKAGES += \
    vendor.lineage.powershare@1.0-service.xiaomi_mars
...
# Sensors
PRODUCT_PACKAGES += \
    android.hardware.sensors@2.1-service.xiaomi_mars-multihal \
    sensors.xiaomi_mars \
...
# Touch
PRODUCT_PACKAGES += \
    vendor.lineage.touch@1.0-service.xiaomi_mars
...
# Vibrator
PRODUCT_PACKAGES += \
    vendor.qti.hardware.vibrator.service.xiaomi_mars
